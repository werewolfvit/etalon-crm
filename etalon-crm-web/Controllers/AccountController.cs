...
namespace etalon_crm_web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController() : this(new UserManager<User>(new UserStore()), new RoleManager<Role>(new RoleStore()))
        {
        }
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var user = _userManager.FindAsync(model.Login, model.Password);
            if (user == null)
                return View();
